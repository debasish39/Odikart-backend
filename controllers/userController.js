...
const checkRequiredSellerDocuments = (
  seller
) => {
  const kyc =
  ...
  async (
    ...
    try {
      ...
      return res.status(500).json({
        success: false,
        message:
          "Unable to fetch pending sellers",
      });
    }
  };
...
export const getApprovedSellers =
  async (
    req,
    res
  ) => {
...
export const getRejectedSellers =
  async (
    req,
    res
  ) => {
    try {
      ...
      return res.status(500).json({
        success: false,
        message:
          "Unable to fetch rejected sellers",
      });
    }
  };
...
export const completeSellerProfile =
  async (
    ...
    try {
      ...
      for (
        const field of allowedStoreFields
      ) {
        if (
          store[field] !==
          undefined
      ...
      for (
        const field of allowedBusinessFields
      ) {
        if (
          business[field] !==
          undefined
  ...
  async (
    ...
    try {
      ...
      if (
        ...
        seller.sellerInfo.store.shopLogo =
      ...
      if (
        ...
        seller.sellerInfo.store.shopBanner =
      ...
      if (
        ...
        seller.sellerInfo.kyc.aadhaar.frontImage =
      ...
      if (
        ...
        seller.sellerInfo.kyc.aadhaar.backImage =
      ...
      if (
        ...
        seller.sellerInfo.kyc.pan.image =
      ...
      if (
        ...
        seller.sellerInfo.kyc.gst.certificate =
      ...
      if (
        ...
        seller.sellerInfo.kyc.bankProof.image =
          files.bankProof[0].path;
      }

      /*
        Every new/re-uploaded submission
...
export const updateSellerCommission =
  async (
    ...
    try {
      ...
      seller.sellerInfo.subscription.commissionRate =
        commissionRate;
      ...
      return res.json({
        success: true,
        message:
          "Seller commission updated successfully",
        commissionRate,
      });

    } catch (error) {
      console.error(
        "Update Seller Commission Error:",
        error
      );
      ...
      return res.status(500).json({
        success: false,
        message:
          "Unable to update seller commission",
      });
    }
  };
...
export const updateSellerPlan =
  async (
    ...
    try {
      ...
      seller.sellerInfo.subscription.plan =
        plan;
      ...
      return res.json({
        success: true,
        message:
          "Seller plan updated successfully",
        plan,
      });

    } catch (error) {
      console.error(
        "Update Seller Plan Error:",
        error
      );
    ...
    try {
      ...
      if (
        ...
        return res.status(403).json({
          success: false,
          message:
            "Deleted seller cannot be reactivated",
        });
      }
      ...
      if (
        ...
        return res.status(403).json({
          success: false,
          message:
            "Blocked seller cannot be reactivated",
        });
      }
